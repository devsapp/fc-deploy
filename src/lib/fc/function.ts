...
export class FcFunction extends FcDeploy<FunctionConfig> {
  ...
  async initLocalConfig(assumeYes?: boolean): Promise<void> {
    ...
    const { codeUri, isBuild } = this.getCodeUriWithBuildPath();
    ...
    if (isBuild) {
      ...
      const message = 'Fc add/append some content to your origin environment variables for finding dependencies generated by build command. Are you sure to continue?';
